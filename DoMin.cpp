...
BEGIN_MESSAGE_MAP(CDoMinApp, CWinAppEx)
...
// CDoMinApp customization load/save methods

void CDoMinApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CDoMinApp::LoadCustomState()
{
}

void CDoMinApp::SaveCustomState()
{
}
